    ...
    return (
        <View className="flex-1 items-center bg-white">
            <ScrollView className="mb-20">
                <TouchableOpacity className='absolute p-5 z-10 left-0' onPress={() => props.navigation.goBack()}>
                    <Image source={require('../../assets/arrow-left.png')} className="w-6 h-6" style={{ tintColor: 'black' }} />
                </TouchableOpacity>
                <Slider />
                <View className="relative mx-auto rounded-2xl font-['Inter-Regular'] mb-5" style={{ width: '95%' }} >
                    <View className="flex flex-row p-4 h-[110px] justify-between">
                        ...
                        <View className="flex justify-between">
                            <Text className="font-['Inter-SemiBold'] text-black text-xs p-1 px-2 bg-gray-200 rounded-xl">Family</Text>
                        </View>
                    </View>
                    <View className="mx-4">
            ...
            <View className="absolute bottom-0 py-4 flex flex-row justify-around w-10/12">
                <TouchableOpacity className="flex-1">
                    <Text className="text-primary font-['Inter-Bold'] border border-primary text-center p-3 rounded-lg w-full my-2">Wishlist</Text>
                </TouchableOpacity>
                <View className="w-5" />
                <TouchableOpacity className="flex-1">
                    <Text className="text-white font-['Inter-Bold'] bg-primary text-center p-3 rounded-lg w-full my-2">Reserve</Text>
                </TouchableOpacity>
            </View>
        </View>
    )
